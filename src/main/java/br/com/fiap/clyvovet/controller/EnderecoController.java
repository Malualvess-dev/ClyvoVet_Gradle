...
public class EnderecoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<EnderecoResponse> readEndereco(
            @PathVariable Integer id
    ) {

        return new ResponseEntity<>(
                enderecoService.readEndereco(id),
                HttpStatus.OK
        );
    }
    ...
    @GetMapping
    public ResponseEntity<Page<EnderecoResponse>> readEnderecos(
            @ParameterObject Pageable pageable
    ) {

        return new ResponseEntity<>(
                enderecoService.read(pageable),
                HttpStatus.OK
        );
    }
    ...
    @GetMapping("/cep")
    public ResponseEntity<Page<EnderecoResponse>> readByCep(
            @RequestParam String cep,
            @ParameterObject Pageable pageable
    ) {

        return new ResponseEntity<>(
                enderecoService.readByCep(cep, pageable),
                HttpStatus.OK
        );
    }
